Shader "UI/OrangeGradient"
{
	Properties
	{
		[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
		_TopLeftColor("Gradient Top Left", Color) = (0.784,0.517,0,1)
		_TopRightColor("Gradient Top Right", Color) = (0.784,0.517,0,1)
		_BottomLeftColor("Gradient Bottom Left", Color) = (1,0.415,0.125,1)
		_BottomRightColor("Gradient Bottom Right", Color) = (1,0.415,0.125,1)
